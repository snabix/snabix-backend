...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'catalogType', type: 'integer', example: 1),
        new OA\Property(property: 'catalogTypeLabel', type: 'string', example: 'Товары'),
        new OA\Property(property: 'parentId', type: 'integer', example: null, nullable: true),
        ...
        new OA\Property(property: 'description', type: 'string', example: 'Товары категории электроника', nullable: true),
