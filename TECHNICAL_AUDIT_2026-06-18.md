...
- [P1] Исправить потенциальный N+1 в breadcrumbs категорий.
...
- [P2] Унифицировать response resources.
...
- [P1] Добавить query count tests из-за риска N+1 в breadcrumbs.
...
- [P1] Убрать потенциальный N+1 в `categoryBreadcrumbs()`.
...
- [ ] Вынести breadcrumbs в отдельный сервис/cache.
- [ ] Вынести address snapshot в DTO.
- [ ] Добавить query count tests.
